...
type Work = { id:number; type:string; title:string; description:string; authorName:string; authorAvatar?:string|null; authorEmoji?:string; status?:string; content?:string; appHtml?:string; externalUrl?:string|null; coverUrl?:string|null; playCount?:number; favoriteCount?:number; isFavorited?:boolean; updatedAt?:string };
